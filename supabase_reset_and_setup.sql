-- =============================================
-- VENDEMOS SUA CASA - RESET E SETUP COMPLETO
-- =============================================
...
DO $$
BEGIN
  RAISE NOTICE '✅ Reset e setup completo do Vendemos Sua Casa executado com sucesso!';
  RAISE NOTICE '🗑️ Estruturas antigas removidas';
  RAISE NOTICE '📊 Tabela users recriada com % colunas', (SELECT COUNT(*) FROM information_schema.columns WHERE table_name = 'users');
