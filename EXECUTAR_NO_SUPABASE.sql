...
-- e execute para criar a tabela user_configuracoes

-- 1. Criar tabela para configurações do utilizador
...
-- 5. Política para permitir que utilizadores vejam apenas suas próprias configurações
...
-- 6. Política para permitir que utilizadores atualizem suas próprias configurações
...
-- 7. Política para permitir que utilizadores criem suas próprias configurações
...
WHERE table_name = 'user_configuracoes' 
