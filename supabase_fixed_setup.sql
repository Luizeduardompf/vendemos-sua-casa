-- =============================================
-- VENDEMOS SUA CASA - SETUP CORRIGIDO
-- =============================================
...
-- =============================================
-- 8. CRIAR VIEWS ÚTEIS (CORRIGIDAS)
-- =============================================
...
-- View para utilizadores com dados de social login (SIMPLIFICADA)
...
DO $$
BEGIN
  RAISE NOTICE '✅ Setup corrigido do Vendemos Sua Casa executado com sucesso!';
