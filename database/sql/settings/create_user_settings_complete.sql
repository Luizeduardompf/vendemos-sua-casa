-- ========================================
-- SCRIPT COMPLETO PARA CRIAR TABELA user_settings
-- ========================================
-- Execute este script no SQL Editor do Supabase

-- 1. Apagar tabela existente se houver
...
-- 10. Testar inserção (substitua USER_ID pelo ID real de um usuário)
-- Primeiro, encontre o ID do usuário de teste
SELECT id, email, nome_completo 
FROM users 
WHERE email = 'teste.config6@example.com';

-- 11. Testar inserção com o ID encontrado (substitua 'USER_ID_AQUI' pelo ID real)
