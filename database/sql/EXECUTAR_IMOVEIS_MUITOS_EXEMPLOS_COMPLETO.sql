-- =============================================
-- VENDEMOS SUA CASA - MUITOS EXEMPLOS DE IMÓVEIS (COMPLETO)
-- =============================================
-- Execute este script no SQL Editor do Supabase
-- Data: 2024-12-19
-- Versão: 1.0 - Script completo com criação de tabelas e muitos exemplos

-- =============================================
-- 1. LIMPAR DADOS EXISTENTES (SE HOUVER)
-- =============================================

-- Dropar views primeiro (devido a dependências)
DROP VIEW IF EXISTS CASCADE imoveis_detalhes CASCADE;
DROP VIEW IF EXISTS CASCADE imoveis_estatisticas CASCADE;
DROP VIEW IF EXISTS CASCADE imoveis_favoritos_view CASCADE;
...
DROP TABLE IF EXISTS CASCADE imoveis_contatos;
DROP TABLE IF EXISTS CASCADE imoveis_favoritos;
DROP TABLE IF EXISTS CASCADE imoveis_views;
DROP TABLE IF EXISTS CASCADE imoveis_amenities;
DROP TABLE IF EXISTS CASCADE imoveis_media;
DROP TABLE IF EXISTS CASCADE imoveis;

-- =============================================
-- 2. CRIAR SCHEMA DE IMÓVEIS
-- =============================================
...
-- Trigger para atualizar updated_at na tabela imoveis_amenities
CREATE OR REPLACE FUNCTION update_imoveis_amenities_updated_at()
RETURNS TRIGGER AS $$
BEGIN
  NEW.updated_at = NOW();
  RETURN NEW;
...
CREATE TRIGGER trigger_update_imoveis_amenities_updated_at
  BEFORE UPDATE ON imoveis_amenities
  FOR EACH ROW
  EXECUTE FUNCTION update_imoveis_amenities_updated_at();
...
-- =============================================
-- 5. INSERIR MUITOS EXEMPLOS DE IMÓVEIS
-- =============================================
...
-- =============================================
-- 7. INSERIR COMODIDADES DE EXEMPLO
-- =============================================
...
-- =============================================
-- 8. INSERIR VISUALIZAÇÕES DE EXEMPLO
-- =============================================
...
-- =============================================
-- 9. INSERIR FAVORITOS DE EXEMPLO
-- =============================================
...
-- =============================================
-- 10. INSERIR CONTATOS DE EXEMPLO
-- =============================================
