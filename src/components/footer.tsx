        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">VENDEMOSSUACASA.PT</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/cadastrar-imovel" className="text-gray-300 hover:text-white transition-colors">
                  Cadastrar Imóvel
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/proprietarios" className="text-gray-300 hover:text-white transition-colors">
                  Para Proprietários
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li className="flex items-center space-x-2">
                ...
                <span>info@vendemossuacasa.pt</span>
              </li>
              <li className="flex items-center space-x-2">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
