      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-8 sm:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="col-span-1 sm:col-span-2 lg:col-span-2">
            ...
            <p className="text-gray-300 mb-4 text-sm sm:text-base max-w-md">
              ...
              Transparência total, sem contratos de exclusividade.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/imoveis" className="text-gray-300 hover:text-white transition-colors text-sm sm:text-base">
                  Ver Imóveis
                </Link>
              </li>
              <li>
                <Link href="/cadastrar-imovel" className="text-gray-300 hover:text-white transition-colors text-sm sm:text-base">
                  Cadastrar Imóvel
                </Link>
              </li>
              <li>
                <Link href="/agentes" className="text-gray-300 hover:text-white transition-colors text-sm sm:text-base">
                  Para Agentes
                </Link>
              </li>
              <li>
                <Link href="/proprietarios" className="text-gray-300 hover:text-white transition-colors text-sm sm:text-base">
                  Para Proprietários
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300 text-sm sm:text-base">
              <li className="flex items-center space-x-2">
                ...
                <span className="break-all">+351 123 456 789</span>
              </li>
              <li className="flex items-center space-x-2">
                <svg className="w-3 h-3 sm:w-4 sm:h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="break-all">info@vendemossuacasa.pt</span>
              </li>
              <li className="flex items-center space-x-2">
                <svg className="w-3 h-3 sm:w-4 sm:h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-800 mt-6 sm:mt-8 pt-6 sm:pt-8 flex flex-col sm:flex-row justify-between items-center space-y-3 sm:space-y-0">
          ...
          <div className="flex flex-wrap justify-center sm:justify-end space-x-4 sm:space-x-6">
            ...
            <Link href="/termos" className="text-gray-400 hover:text-white text-xs sm:text-sm transition-colors">
              Termos de Uso
            </Link>
