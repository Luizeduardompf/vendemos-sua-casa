...
export default function MeusDadosPage() {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({
          ...
          nif: data.user.nif || '',
          tipo_pessoa: data.user.tipo_pessoa || 'coletiva'
        });
      }
    } catch (error) {
  ...
  const validateForm = () => {
    ...
    if (!formData.nome_completo.trim()) {
      newErrors.nome_completo = 'Nome da empresa é obrigatório';
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <Label htmlFor="nome_completo">Nome da Empresa *</Label>
                  <Input
                    id="nome_completo"
                ...
                <Button
                  ...
                  onClick={() => {
                    setFormData({
                      ...
                      nif: userData?.nif || '',
                      tipo_pessoa: userData?.tipo_pessoa || 'coletiva'
                    });
                    setErrors({});
                    setMessage(null);
                  }}
