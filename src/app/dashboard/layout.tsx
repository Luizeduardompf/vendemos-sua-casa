...
export default function DashboardLayout({
  ...
  return (
    <ThemeProvider attribute="class" defaultTheme="light" enableSystem={false}>
      <div className="fixed inset-0 bg-gray-50 dark:bg-gray-900 dashboard-container">
        <div className="flex h-full">
          ...
          <div className="flex-1 flex flex-col h-full">
            {/* Header */}
            <header className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-6 py-2 flex-shrink-0 min-h-[48px] h-12">
