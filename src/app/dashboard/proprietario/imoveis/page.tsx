...
import { Construction, Clock, Info } from 'lucide-react';
      ...
      <div className="flex flex-col items-center justify-center min-h-[400px] text-center">
        ...
        <div className="max-w-md mx-auto space-y-4">
          <Message
            ...
            description="Esta página está sendo desenvolvida e estará disponível em breve. Aqui você poderá gerenciar todos os seus imóveis cadastrados."
          />
