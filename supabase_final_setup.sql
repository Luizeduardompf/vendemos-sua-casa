-- =============================================
-- VENDEMOS SUA CASA - SETUP FINAL
-- =============================================
-- Execute este script no SQL Editor do Supabase
-- Data: 2024-10-12
-- Versão: 1.2 (Final - Simplificado)
...
DROP VIEW IF EXISTS users_with_social_data CASCADE;
DROP VIEW IF EXISTS users_pending_approval CASCADE;
DROP VIEW IF EXISTS admin_dashboard CASCADE;
DROP VIEW IF EXISTS agentes_por_imobiliaria CASCADE;
DROP VIEW IF EXISTS proprietarios_ativos CASCADE;
...
DROP FUNCTION IF EXISTS promote_to_admin(UUID, INTEGER) CASCADE;
DROP FUNCTION IF EXISTS update_user_from_social_login(UUID, VARCHAR) CASCADE;
...
-- =============================================
-- 2. CRIAR TABELA PRINCIPAL DE UTILIZADORES
-- =============================================
...
-- =============================================
-- 8. CRIAR VIEWS ÚTEIS (SIMPLIFICADAS)
-- =============================================
...
-- View para utilizadores com dados básicos de auth (SIMPLIFICADA)
CREATE VIEW users_with_auth_data AS
SELECT 
  u.*,
...
DO $$
BEGIN
  RAISE NOTICE '✅ Setup final do Vendemos Sua Casa executado com sucesso!';
  RAISE NOTICE '🗑️ Estruturas antigas removidas';
  ...
  RAISE NOTICE '🔗 Social login integrado automaticamente';
  RAISE NOTICE '👥 Tipos de utilizador: proprietario, agente, imobiliaria, admin';
END $$;
